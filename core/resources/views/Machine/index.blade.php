                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                <tbody>
                                @foreach($fuelmachines as $k => $fuelmachine)
                                    <tr>
                                        <td>{{ ++$k }}</td>
                                        <td>{{$fuelmachine->name}}</td>
                                        <td>{{$fuelmachine->code}}</td>
                                        <td>{{$fuelmachine->fuel->name}}</td>
                                         <td>
                                            @if($fuelmachine->status == 1)
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger bold uppercase delete_button"
                                                    ...
                                                    data-id="{{ $fuelmachine->id }}" title="Delete">
