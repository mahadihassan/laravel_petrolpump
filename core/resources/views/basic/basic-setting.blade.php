                            ...
                            {!! Form::model($basic,['route'=>['basic-update',$basic->id],'method'=>'PUT','class'=>'form form-horizontal']) !!}
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">FORCED HTTPS</strong></label>
                                                <div class="col-md-12">
                                                    <input data-toggle="toggle" {{ env('APP_HTTPS') == true ? 'checked' : ''}} data-onstyle="success" data-offstyle="danger" data-on="ENABLE" data-off="DISABLE" data-width="100%" type="checkbox" name="https">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Web Maintenance</strong></label>
                                                <div class="col-md-12">
                                                    <input data-toggle="toggle" {{ env('APP_MAINTENANCE') == true ? 'checked' : ''}} data-onstyle="success" data-offstyle="danger" data-on="ENABLE" data-off="DISABLE" data-width="100%" type="checkbox" name="web_mood">
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      <!--  <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Email Verify</strong></label>
                                                <div class="col-md-12">
                                                    <input data-toggle="toggle  data-onstyle="success" data-offstyle="danger" data-on="ENABLE" data-off="DISABLE" data-width="100%" type="checkbox" name="email_verify">
                                                </div>
                                            </div>
                                        </div>
                                    -->
                                     <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Measurement Unit</strong></label>
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input class="form-control bold input-lg" name="symbol" value="{{ $basic->unit }}" type="text" required>
                                                        <span class="input-group-addon"><strong><i class="fa fa-money"></i></strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Phone Verify</strong></label>
                                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea name="meta_tag" class="form-control bold input-lg" id="" cols="30" rows="1"> {{ $basic->meta_tag }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Web Description</strong></label>
                                                <div class="col-md-12">
