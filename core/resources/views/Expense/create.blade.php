                                ...
                                {{csrf_field()}}
                                 <div class="form-body">
                                    <div class="form-group row">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Expense Name</strong></label>
                                       <div class="col-md-12">
                                            <input type="text" name="name" class="form-control input-lg" placeholder="Expense Cost" required/>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Expense Cost</strong></label>
                                        <div class="col-md-12">
                                            <input type="text" name="cost" class="form-control input-lg" placeholder="Expense Cost" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <button type="submit"class="btn btn-primary btn-block bold btn-lg uppercase"><i class="fa fa-send"></i>Create Expense</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
