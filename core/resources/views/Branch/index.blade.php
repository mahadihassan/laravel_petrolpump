                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                ...
                                @foreach($branch as $k => $branchs)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('branch-edit',$branchs->id) }}" class="btn btn-sm btn-primary bold uppercase"><i class="fa fa-edit"></i> Edit</a>
                                            <button type="button" class="btn btn-sm btn-danger bold uppercase delete_button"
                                                    data-toggle="modal" data-target="#DelModal"
                                                    data-id="{{ $branchs->id }}" title="Delete">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" >
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('branch-delete') }}" class="form-inline">
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
