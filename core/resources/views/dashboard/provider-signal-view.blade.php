                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-8 offset-2">
                                    <div class="card text-white box-shadow-0 bg-gradient-radial-primary rounded">
                                        <div class="card-header">
                                        ...
                                        <div class="card-content collpase show">
                                            <div class="card-body">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn bg-softwarezon-x border-0 white btn-lg btn-block "> <i class="fa fa-send"></i> Signal Action</button>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function () {
            $(document).on("change", '#status', function (e) {
                var type = $(this).val();
                if (type == "0"){
                    $("#accept").addClass("hidden");  // To hide
                }else if (type == "1"){
            ...
            $(document).on("change", '#publish', function (e) {
                var type = $(this).val();
                if (type == "0"){
                    $("#schedule").addClass("hidden");  // To hide
                }else {
