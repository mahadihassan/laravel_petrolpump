...
<head>
    <meta charset="utf-8" />
    <title>503 Page | Maintenance Page</title>
    <link href="{{ asset('assets/admin/css/error-503.css') }}" rel="stylesheet"/>
...
<div id="level">
    <div id="content">
        ...
        <div id="title">
            <img width="35%" src="{{ asset('assets/images/logo.png') }}" alt="">
            <h1>web now under maintenance<br />we are coming so soon.!</h1>
        </div>
    </div>
</div>
</body>
