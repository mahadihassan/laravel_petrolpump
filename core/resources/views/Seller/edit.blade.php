                                ...
                                {{csrf_field()}}
                                 <div class="form-body">
                                        ...
                                        <div class="col-md-12">
                                            <select name="branch_id" id="branch" class="form-control" required>
                                                ...
                                                @foreach($branchs as $branch)
                                                    <option value="{{$branch->id}}" {{$seller->branch_id == $branch->id ? 'selected' : ''}}>{{$branch->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" class="form-control input-lg" value="{{$seller->name}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="phone" class="form-control input-lg" value="{{$seller->phone}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="Email" name="email" class="form-control input-lg" value="{{$seller->email}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="address" class="form-control" rows="3" placeholder="Address" >{{$seller->address}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Status<span class="text-danger">*</span></strong></label>
                                            <div class="col-md-12">
                                                <input data-toggle="toggle" {{$seller->status == 1 ? 'checked' : ''}} data-onstyle="success" data-offstyle="danger" data-on="Show" data-off="Hide" data-width="100%" type="checkbox" name="status">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary btn-block bold btn-lg uppercase"><i class="fa fa-send"></i> Update Seller</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
