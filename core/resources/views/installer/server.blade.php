    ...
    <div class="sw-main sw-theme-arrows">
        ...
        <div class="sw-container tab-content">
            ...
            <div class="tab-pane step-content" style="display: block;">
                <h2 class="pb-1 pt-2 text-center font-weight-bold text-uppercase sw-border" style="border-bottom: 2px solid #302e2e">Check Server Requirement</h2>
        ...
        <div class="row btn-toolbar sw-toolbar sw-toolbar-bottom">
            ...
            <div class="col-sm-6">
                ...
                @else
                    <button class="btn btn-success font-weight-bold mr-1 text-uppercase pull-right" onclick="window.location.href='{{ route('check-permission') }}'">
