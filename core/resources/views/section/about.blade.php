                                ...
                                <div class="row">
                                    <div class="col-md-10 offset-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea name="about_description" id="area2" cols="10" rows="3" class="form-control input-lg" placeholder="Description" required>{{ $section->about_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
