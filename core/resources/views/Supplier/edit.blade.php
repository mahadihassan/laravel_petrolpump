                                ...
                                {{csrf_field()}}
                                 <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" class="form-control input-lg" value="{{$supplier->name}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="phone" class="form-control input-lg" value="{{$supplier->phone}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <input type="Email" name="email" class="form-control input-lg" value="{{$supplier->email}}" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Status<span class="text-danger">*</span></strong></label>
                                            <div class="col-md-12">
                                                <input data-toggle="toggle" {{$supplier->status==1 ? 'checked': ''}}  data-onstyle="success" data-offstyle="danger" data-on="Show" data-off="Hide" data-width="100%" type="checkbox" name="status">
                                            </div>
                                        </div>

                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-primary btn-block bold btn-lg uppercase"><i class="fa fa-send"></i>Update Supplier</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
